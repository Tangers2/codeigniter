...
<div id="container">
	...
	<?php
	 ...
	 foreach ($students as $student){
		...
		'<a href="edit.php?id=' . $student->students . '" class="btn btn-secondary" style="margin-left: 5px;">Edit</a>'.
		'<a href="del_main.php?id=' . $student->students . '" class="btn btn-danger" onclick="return confirm(\'Are you sure you want to delete this data?\')" style="margin-left: 5px;">DELETE</a>'.
		'</td>';
